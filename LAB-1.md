...
* Функция match(x,y) - сопоставляет значение объекта x со значением объекта y и возвращает поряд. номер первого из совпадающих значений
...
>Объяснение:
>По сути, data frame - представляет из себя списки и таблицы.
